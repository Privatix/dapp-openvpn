...
#             Andreev Andrei for Privatix (removed SMB), 15.01.2019
#
# ******************************************************************************************************************
...
EOF
	...
	logDebugMessage "DEBUG:"
	logDebugMessage "DEBUG: Pause for configuration changes to be propagated to State:/Network/Global/DNS"
	sleep 1
...
EOF
	...
	logMessage "Saved the DNS configurations so they can be restored"
